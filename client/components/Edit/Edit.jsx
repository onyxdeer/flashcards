    ...
    return (
      <div className="editSection">
        ...
        <div className="ops-div">
          <button type="submit" id="submit" name="submit" className="btn btn-sm btn-default form-btn semibold animated slideInRight" data-delay = ".9s" onClick ={() => {this.props.handleSaveBento(this.props.bento)}}>Save Bento</button> 
        </div>
      </div>
    )
  }

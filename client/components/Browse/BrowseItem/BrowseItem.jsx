      ...
      <div className='thumbnailSpace wow bounceInDown'>
        <span className='thumbnail'>
          ...
          <div className='caption exploreItems'>
            ...
            <p className='exploreItems'><Link className='btn btn-primary' to={'/display'} onClick={() => this.props.setBentoId(this.props.item.id)}><i className="fa fa-binoculars" aria-hidden="true"></i></Link><span>   </span><Link className='btn btn-default' to={'/edit'} onClick={() => this.props.handleFetchBentoForEdit(this.props.bento, this.props.item.id, this.props.userId)}><i className="fa fa-pencil" aria-hidden="true"></i></Link></p>

      ...
      <nav className="navbar navbar-fixed-top navbar-default">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <form className="navbar-form navbar-left" onSubmit={this.props.handleNavSubmit}>
              <div className="form-group">
                <input type="text" className="form-control" value={this.props.query} placeholder="Find A Bento Here" onChange={this.props.handleNavSearch} />
              </div>
